...
Fig. \ref{fig:classifier} demonstrates the results when applying various classifiers with all features we can use. \todo{Please give any possible explanation about these results.}
